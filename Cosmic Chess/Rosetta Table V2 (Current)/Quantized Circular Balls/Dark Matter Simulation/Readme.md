...
Full Colab (All Modules Together) -  https://colab.research.google.com/drive/1QIGjhJC3rPKN6QWBkfphuzkhK0Z4ktX6?usp=sharing  
(output is too long and gets truncated from the full version fair warning, so I will only post the last 1k-2k lines as the Dark Matter Output)
